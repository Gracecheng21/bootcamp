...
public class DemoOptional {
  ...
  public static void main(String[] args) {
    ...
    System.out.println(findByBookName2("OPQ"));
    ...
    Optional<Book> targetBook2 = findByPublishDate(LocalDate.of(2020, 1, 1));
  ...
  public static Book findByBookName(String name) {
    ...
    return null; // Not Found. But we don't treat is as System Error.
  }
  ...
  // Optional<List<Book>>
  // Find all book with publish Date after 2020.
  // List<Book> -> ArrayList with size 0
  // Optional<List<Book>> -> Optional object with null value
  public static Optional<Book> findByPublishDate(LocalDate publishDate) {
    if (publishDate == null)
