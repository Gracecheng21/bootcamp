...
public class DemoPassByValue {
  public static void main(String[] args) {
    // ! 1.String is Pass By Value, copy of the original String
    String p1 = "hello";
    String p2 = "john";
    System.out.println(compareStringLength(p1, p2)); // 1
    System.out.println(p1); // hello
    // ! 2. Pass By Reference （Array, all other Customer Classes), create a new array different with the original
