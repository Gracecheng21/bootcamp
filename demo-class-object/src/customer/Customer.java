...
public class Customer {
  ...
  // Constructor (blank for create new one in method)
  public Customer() {
...
//  }
  ...
  // Setter
  public void add(Order newOrder) { // 由開發者控制新增order
    Order[] orders = new Order[this.orders.length + 1]; // 開新array+1格
    for (int i = 0; i < this.orders.length; i++) { // for loop 抄原有舊array
